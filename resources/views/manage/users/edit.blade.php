...
@section('content')
	<div class="flex-container">
			...
			<div class="columns">
				<div class="column">
					...
					<div class="field">
						...
						<p class="control">
							<input type="text" name="email" class="input" id="email" value="{{$user->email}}">
						</p>
					</div>
						...
						<div class="block">
							...
							<div class="field">
								...
								<p class="control m-t-5">
									<input type="password" class="input" name="password" id="password" placeholder="Manually give a password to this user" v-if="password_options == 'manual'">
								</p>
							</div>
						</div>
			        </div>
		...
		<div class="columns">
			<div class="column">
				<hr>
				<button class="button is-primary is-pulled-right" style="width: 200px;">Edit User</button>
			</div>
		</div>
	</form>
