							...
							<div class="content">
								...
								<div class="field">
									<p class="control">
										...
										<input type="text" name="display_name" class="input" id="display_name" value="{{old('display_name')}}">
									</p>
								</div>
								<div class="field">
									<p class="control">
										<label for="name" class="label">Slug (Cannot be edited)</label>
										<input type="text" name="name" class="input" id="name" value="{{old('name')}}">
									</p>
								</div>
								<div class="field">
									<p class="control">
										<label for="description" class="label">Description</label>
										<input type="text" name="description" class="input" id="description" value="{{old('description')}}">
									</p>
								</div>
