...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('successs', 'Successfully create the '. $role->display_name .' role in the database.');
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('successs', 'Successfully update the '. $role->display_name .' role in the database.');
